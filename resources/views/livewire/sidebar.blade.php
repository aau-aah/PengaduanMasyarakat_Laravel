<aside id="logo-sidebar"
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        <ul class="space-y-2">
            <li>
                <a href="/"
                    class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 {{ Request::is('/') ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
            ...
            @if (Auth::user()->level === 'admin' || Auth::user()->level === 'petugas')
                <li>
                    <a href="/masyarakat"
                        class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 {{ Request::is('masyarakat') ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
                        ...
                        <span class="ml-3">Masyarakat</span>
                    </a>
                </li>
            @endif
            <li>
                <a href="{{ route('pengaduan.index') }}"
                    class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 {{ Request::is('pengaduan') ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
                    ...
                    @if (
                        (Auth::user()->level === 'admin' && $countPengaduan >= 1) ||
                            (Auth::user()->level === 'petugas' && $countPengaduan >= 1))
                        <span
                            class="inline-flex items-center justify-center w-3 h-3 p-3 ml-3 text-md font-medium text-red-800 bg-red-100 rounded-full dark:bg-red-900 dark:text-red-300">{{ $countPengaduan }}</span>
                    @endif
                </a>
            </li>
            <li>
                <a href="/tanggapan"
                    class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 {{ Request::is('tanggapan') ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg"
                        class="w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                        fill="currentColor" viewBox="0 0 512 512">
                        <path
                    ...
                    <span class="flex-1 ml-3 whitespace-nowrap">Tanggapan</span>
                </a>
            </li>
            {{-- <li>
                <a href="#"
                    ...
                    <span
                        class="inline-flex items-center justify-center w-3 h-3 p-3 ml-3 text-md font-medium text-blue-800 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300">3</span>
                </a>
            </li> --}}
            {{-- <li>
                <a href="#"
